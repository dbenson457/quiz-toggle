...
describe('Question Component', () => {
  test('renders the question title', () => {
    render(<Question title="Sample Question" options={mockOptions} selections={["left", "left"]} locked={false} onSelectionChange={mockOnSelectionChange} />);
  ...
  test('displays correct message when all selections are correct', () => {
    render(<Question title="Sample Question" options={mockOptions} selections={["right", "left"]} locked={true} onSelectionChange={mockOnSelectionChange} />);
  ...
  test('updates state correctly when navigating between questions', () => {
    const { rerender } = render(<Question title="Sample Question 1" options={mockOptions} selections={["left", "left"]} locked={false} onSelectionChange={mockOnSelectionChange} />);
    rerender(<Question title="Sample Question 2" options={mockOptions} selections={["right", "left"]} locked={true} onSelectionChange={mockOnSelectionChange} />);
